...
-- ----------------------------
-- Table structure for deploy_node_states
-- ----------------------------
DROP TABLE IF EXISTS `deploy_node_states`;
CREATE TABLE `deploy_node_states` (
...
) ENGINE=InnoDB AUTO_INCREMENT=29196 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
